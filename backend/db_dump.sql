CREATE DATABASE  IF NOT EXISTS `karaoke` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `karaoke`;
...
INSERT INTO `genres` VALUES (1,'POP','2025-09-10 02:52:09',NULL,NULL),(2,'ROCK','2025-09-10 02:52:09',NULL,NULL),(3,'RAP','2025-09-10 02:52:09',NULL,NULL),(4,'RNB/SOUL','2025-09-10 02:52:09',NULL,NULL),(5,'LATINO','2025-09-10 02:52:09',NULL,NULL);
...
CREATE TABLE `songs` (
  ...
  `path_to_audio` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `path_to_lyrics` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`song_id`),
...
-- Dump completed on 2025-09-19 15:03:34
